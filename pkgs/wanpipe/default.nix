...
in
  stdenv.mkDerivation {
    ...
    nativeBuildInputs = kernel.moduleBuildDependencies ++ [bash];
    # ++ [autoconf automake libtool bison flex ncurses.dev];
    ...
    preConfigure = ''
      patchShebangs ./patches
    '';

    patches = [
      ./00-rename-EXTRA_FLAGS-to-ccflags-y.patch
      ./01-rename-del_timer-to-timer_delete.patch
      ./02-fix-class_create-call.patch
